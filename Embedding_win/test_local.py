...
def main():
    ...
    parser.add_argument('--output', '-o', default='testtable_with_vector1.csv', help='输出 CSV 文件路径')
    ...
    output_rows = []
    for row, embedding in zip(rows, response.data):
        row[args.column_name] = json.dumps(embedding.embedding, ensure_ascii=False)
