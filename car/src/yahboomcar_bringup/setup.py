...
setup(
    ...
    entry_points={
        ...
        'FourWD_driver = yahboomcar_bringup.FourWD_driver:main',
        'calibrate_linear_FourWD = yahboomcar_bringup.calibrate_linear_FourWD:main',
        'calibrate_angular_FourWD = yahboomcar_bringup.calibrate_angular_FourWD:main',
        'patrol_FourWD = yahboomcar_bringup.patrol_FourWD:main',
        'test_FourWD = yahboomcar_bringup.test_FourWD:main',
        'simple_test = yahboomcar_bringup.simple_test:main',   
        ],
    },
)
